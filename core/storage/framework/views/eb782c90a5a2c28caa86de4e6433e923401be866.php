<?php $__env->startSection('content'); ?>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="plan-item">
                            <div class="plan-name-area">
                                <h3 class="plan-name mb-2" style="font-size: 25px;"><?php echo e($plan->plan_name); ?></h3>
                            ...
                            <div class="plan-fatures">
                                <ul class="plan-list">
                                    ...
                                    <li>
                                        ...
                                        <span class="details"> <?php echo e($plan->how_many_time); ?> <?php echo e(__('Times Accumulated Profit')); ?></span>
                                    </li>
                                    <?php else: ?>
                                    <li>
                                        <span class="caption"><?php echo e(__('For')); ?> </span>
    ...
    <?php if($plan->lock == 1): ?>
        <a class="main-btn plan-btn w-100 disabled" href="#">
            <span><?php echo e(__('Plan Locked')); ?></span>
        </a>
    <?php elseif($plan_exist >= $plan->invest_limit): ?>
        <a class="main-btn plan-btn w-100 disabled" href="#">
    ...
    <?php else: ?>
        ...
        <?php if(auth()->guard()->check()): ?>
            <button class="main-btn2 bg-white sp_text_dark balance w-100 mt-2" data-plan="<?php echo e($plan); ?>" data-url="">
                <span><?php echo e(__('Invest Using Balance')); ?></span>
            </button>
        <?php endif; ?>
    <?php endif; ?>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(template().'layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/pages/investmentplan.blade.php ENDPATH**/ ?>