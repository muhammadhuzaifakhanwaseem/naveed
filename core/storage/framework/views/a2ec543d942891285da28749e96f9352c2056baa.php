...
<head>
    ...
    <link href="<?php echo e(asset('asset/theme4/frontend/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">

    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/boxicons/css/boxicons.min.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('asset/theme4/frontend/css/slick.css')); ?>">
    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('asset/theme4/frontend/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('asset/theme4/frontend/css/selectric.css')); ?>">
...
<body>
            ...
            <div class="header-right d-flex">
                ...
                <div class="dropdown ms-3">
                    <button class="dropdown-toggle user-toggle-menu" type="button" id="dropdownMenuButton1"
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('asset/theme4/frontend/img/user.png')); ?>" alt="pp">
                        <?php endif; ?>
    ...
    <script src="<?php echo e(asset('asset/theme4/frontend/vendor/purecounter/purecounter.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/theme4/frontend/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>

    <script src="<?php echo e(asset('asset/theme4/frontend/js/feather.min.js')); ?>"></script>

    <script src="<?php echo e(asset('asset/theme4/frontend/js/slick.min.js')); ?>"></script>

    <script src="<?php echo e(asset('asset/theme4/frontend/vendor/glightbox/js/glightbox.min.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/theme4/frontend/vendor/php-email-form/validate.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/theme4/frontend/js/selectric.min.js')); ?>"></script>
...
<?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/layout/master2.blade.php ENDPATH**/ ?>