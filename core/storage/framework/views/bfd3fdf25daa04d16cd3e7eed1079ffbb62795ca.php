                    ...
                    <form action="<?php echo e(url('withdraw')); ?>" method="post">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <span class="color-change"><?php echo e(number_format(auth()->user()->balance, 2) . ' ' . $general->site_currency); ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <?php if(!$accountBind): ?>
                                <div class="alert alert-danger">
                                    ...
                                    <a href="<?php echo e(url('account/bind')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Bind Now')); ?></a>
                                </div>
                            <?php else: ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control text-black" value="<?php echo e($accountBind->withdrawMethod->name); ?>" disabled>
                                </div>

                                <div class="form-group">
                                    <label><?php echo e(__('Withdraw Charge')); ?></label>
                                    <input type="text" class="form-control charge text-black" value="<?php echo e(number_format($accountBind->withdrawMethod->charge, 2)); ?>" required disabled>
                                </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/user/withdraw/index.blade.php ENDPATH**/ ?>