        ...
        <div class="row gy-4">
            <div class="col-xl-3">
                <div class="sp_user_sidebar h-100">
                    ...
                    <?php if($accountBind): ?>
                        <form action="<?php echo e(url('/admin/delete-acc-bind/' . $accountBind->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-danger">Delete Account Bind</button>
                        </form>
                    <?php endif; ?>
            ...
            <div class="col-xl-9 mt-xl-0 mt-4">
                <div class="sp_user_details">
                    <ul class="nav nav-tabs sp_nav_tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="perfomance-tab" data-toggle="tab" data-target="#perfomance"
                                type="button" role="tab" aria-controls="perfomance"
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mt-3">
                                                <p for=""><?php echo e(__('Allow Perfomance Chart')); ?></p>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="is_perfomance"
                                                        <?php echo e($user->is_perfomance ? 'checked' : ''); ?> name="email_status"
                                                        class="custom-control-input" id="customSwitch5">
                                                    <label class="custom-control-label"
                                                        for="customSwitch5">Active/Deactive</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade pt-3" id="perfomance" role="tabpanel"
                            aria-labelledby="perfomance-tab">
                            <div class="container mt-5">
                                <!-- Active and Inactive Users -->
                                <h3>User Status in Downline</h3>
                                <p><strong>Total Active Users:</strong> <?php echo e($activeUsers); ?></p>
                                <p><strong>Total Inactive Users:</strong> <?php echo e($inactiveUsers); ?></p>

                                <!-- Downline Deposit and Withdraw -->
                                <h3>Downline Financial Summary</h3>
                                <p><strong>Total Downline Deposit:</strong> <?php echo e(number_format($downlineDeposit, 2)); ?></p>
                                <p><strong>Total Downline Withdraw:</strong> <?php echo e(number_format($downlineWithdraw, 2)); ?></p>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            balanceTabButton.addEventListener("click", function(event) {
                ...
                if (userPassword === correctPassword) {
                    // ✅ Tab کو manually activate کرو
                    $(balanceTabButton).tab('show');
                } else {
                    alert("Incorrect Password! Access Denied.");
                    location.reload(); // ❌ غلط password پر page refresh کروا دو
                }
            });
        });
    </script>
