                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-caption="<?php echo e(__('Payment Date')); ?>">
                                        <?php echo e($transaction->created_at->format('Y-m-d')); ?></td>
                                    <td data-caption="<?php echo e(__('Proof')); ?>">
                                        <?php if(!empty($transaction->payment_proof) && is_array($transaction->payment_proof)): ?>
                                            <?php $__currentLoopData = $transaction->payment_proof; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(is_array($proof) && isset($proof['file'])): ?>
                                                    <img src="<?php echo e(getFile('manual_payment', $proof['file'])); ?>"
                                                        alt="Payment Proof" class="w-50"
                                                        style="cursor: pointer; max-width: 80px;"
                                                        onclick="showProofModal('<?php echo e(getFile('manual_payment', $proof['file'])); ?>')">
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php echo e(__('No Proof')); ?>
