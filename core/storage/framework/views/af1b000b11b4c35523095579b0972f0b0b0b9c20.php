    ...
    <section class="auth-section">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2"><?php echo e(__('Haven\'t an Account?')); ?></span> <a class="btn main-btn btn-sm" href="<?php echo e(route('user.register')); ?>"><?php echo e(__('Register')); ?></a></p>
            </div>
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="" method="POST">
                        ...
                        <?php endif; ?>
                        <button class="btn main-btn w-100 mt-3" type="submit"> <span><?php echo e(__('Log In')); ?> </span></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/user/auth/login.blade.php ENDPATH**/ ?>