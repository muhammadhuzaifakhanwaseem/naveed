                ...
                success: function(response) {
                    ...
                    let html = `
                        <div class="col-md-12 mb-3 mt-3">
                            <label for="email"><?php echo e(__('Account Email / Wallet Address')); ?> <span class="text-danger">*</span></label>
                            <input type="email" name="email" class="form-control" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="account_information"><?php echo e(__('Account Information')); ?></label>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/user/account_bind.blade.php ENDPATH**/ ?>