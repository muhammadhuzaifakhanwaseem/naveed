...
<!--        <p><?php echo e(__('Profile Picture')); ?></p>-->
        ...
        <!-- Static profile icon -->
<!--        <img class="rounded w-100" id="file-id-preview" -->
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/user/profile.blade.php ENDPATH**/ ?>