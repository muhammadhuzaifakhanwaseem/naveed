            ...
            <div class="col-12 d-sm-none">
                <div class="row gy-4 mobile-box-wrapper">
                    ...
                    <div class="col-3">
                        ...
                        <div class="mobile-box link-item">
                            <a href="<?php echo e(route('user.perfomance.chart')); ?>" class="item-link"></a>
                            <img src="<?php echo e(asset('asset/theme4/images/d-icon/2.png')); ?>" alt="icon">
                            <h6 class="title"><?php echo e(__('Perfomance Chart')); ?></h6>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="col-3">
