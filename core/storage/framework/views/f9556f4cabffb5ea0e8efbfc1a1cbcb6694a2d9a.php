        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <form action="<?php echo e(route('user.auth.verify')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            <input type="hidden" name="email" value="<?php echo e($email); ?>">
                            <div class="mb-3">
                                <label><?php echo e(__('Verify Code')); ?></label>
                                <input type="code" class="form-control" name="code"
                                placeholder="<?php echo e(__('Enter Code Here')); ?>">
                            </div>
                            ...
                            <?php endif; ?>
                            <button type="submit" class="btn main-btn w-100"><span><?php echo e(__('Verify Now')); ?></span></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145197596/domains/opecfuture.com/public_html/core/resources/views/theme4/user/auth/verify.blade.php ENDPATH**/ ?>