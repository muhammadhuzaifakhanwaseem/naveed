        ...
        <div class="row gy-4">
            <div class="col-xl-3">
                <div class="sp_user_sidebar h-100">
                    ...
                    @if ($accountBind)
                        <form action="{{ url('/admin/delete-acc-bind/' . $accountBind->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mt-3">
                                                <p for="">{{ __('Allow Perfomance Chart') }}</p>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="is_perfomance"
                                                        {{ $user->is_perfomance ? 'checked' : '' }} name="email_status"
                        ...
                        <div class="tab-pane fade pt-3" id="password" role="tabpanel" aria-labelledby="password-tab">
                            <form action="{{ route('admin.user.password.update', $user->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label>{{ __('Change User Password') }}</label>
                        ...
                        <div class="tab-pane fade pt-3" id="perfomance" role="tabpanel"
                            ...
                            <div class="container mt-5">
                                ...
                                <p><strong>Total Inactive Users:</strong> {{ $inactiveUsers }}</p>

                                <!-- Downline Deposit and Withdraw -->
                                <h3>Downline Financial Summary</h3>
                                <p><strong>Total Downline Deposit:</strong> {{ number_format($downlineDeposit, 2) }}</p>
                                <p><strong>Total Downline Withdraw:</strong> {{ number_format($downlineWithdraw, 2) }}</p>
