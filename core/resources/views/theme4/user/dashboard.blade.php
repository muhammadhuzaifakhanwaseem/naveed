...
@section('content2')
    ...
    <div class="dashboard-body-part">
        <div class="row gy-4">
            <div class="row g-sm-4 g-3 justify-content-between">
                <p class="caption">{{ __('Upliner Name') }} : <span class="fw-bold text-warning text-uppercase">{{$UplinerName}}</span></p>
                <div class="col-xl-4 col-lg-6">
                    <div class="user-account-number h-100">
                        <div class="card-dot mb-sm-4 mb-2">
                            <span class="dot-1"></span>
                        ...
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-1">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($withdraw, 2) . ' ' . $general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-3">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($totalDeposit, 2) . ' ' . $general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-2">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($totalInvest, 2) . ' ' . $general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-4">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ isset($currentInvest->amount) ? number_format($currentInvest->amount, 2) : 0 }} {{ @$general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-5">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($pendingInvest, 2) . ' ' . $general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-6">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($pendingWithdraw, 2) . ' ' . $general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="d-box-three gr-bg-7">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title text-white">{{ number_format($commison, 2) }} {{ @$general->site_currency }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 d-sm-none">
                <div class="row gy-4 mobile-box-wrapper">
                    ...
                    <div class="col-3">
                        ...
                        <div class="mobile-box link-item">
                            <a href="{{ route('user.perfomance.chart') }}" class="item-link"></a>
                            <img src="{{ asset('asset/theme4/images/d-icon/2.png') }}" alt="icon">
                            <h6 class="title">{{ __('Perfomance Chart') }}</h6>
                        </div>
                        @endif
                    </div>
                    <div class="col-3">
                        <div class="mobile-box link-item">
                            ...
                            <img src="{{ asset('asset/theme4/images/d-icon/8.png') }}" alt="icon">
