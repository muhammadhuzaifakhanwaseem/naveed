...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'demo'])->group(function () {
        ...
        Route::middleware('permission:manage-user,admin')->group(function () {
            Route::get('/admin/users', [ManageUserController::class, 'SearchUser'])->name('user.list');
            ...
            Route::post('users/password/update/{user}', [ManageUserController::class, 'userPasswordUpdate'])->name('user.password.update');
            ...
            Route::delete('/delete-acc-bind/{id}', [ManageUserController::class, 'DeleteAccountBind']);
...
Route::name('user.')->group(function () {
    ...
    Route::middleware(['auth', 'inactive', 'is_email_verified'])->group(function () {
        ...
        Route::middleware('2fa', 'kyc')->group(function () {
            ...
            // Route::middleware(['auth', 'account.bound'])->group(function () {
            //     Route::get('/withdraw', [UserController::class, 'withdraw'])->name('withdraw');
            // });
            ...
            Route::get('account/bind', [UserController::class, 'accountBind'])->name('user.account.bind');
            ...
            Route::get('playstore', [SiteController::class, 'playstore'])->name('playstore.index');
            Route::get('certificate', [SiteController::class, 'certificate'])->name('certificate.index');
